...
export class InitialSchema1774364856062 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."audit_logs_resourcetype_enum" AS ENUM('organization', 'user', 'invitation', 'api_key', 'plan', 'webhook')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."usage_records_metric_enum" AS ENUM('api_calls', 'webhook_calls', 'data_storage', 'active_users')`);
        await queryRunner.query(`CREATE TABLE "usage_records" ("id" SERIAL NOT NULL, "metric" "public"."usage_records_metric_enum" NOT NULL, "value" integer NOT NULL, "period" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "organizationId" uuid NOT NULL, CONSTRAINT "UQ_5ed87ee9a067c0d25b59f0dc35d" UNIQUE ("organizationId", "metric", "period"), CONSTRAINT "PK_e511cf9f7dc53851569f87467a5" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_139b12af7ac259044807889d06" ON "usage_records" ("organizationId") `);
        ...
        await queryRunner.query(`CREATE TYPE "public"."webhook_deliveries_status_enum" AS ENUM('success', 'pending', 'failed')`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_e4dca936b75c3f9d0d38ff1845" ON "webhook_deliveries" ("webhookEndpointId") `);
        ...
        await queryRunner.query(`ALTER TABLE "audit_logs" ADD CONSTRAINT "FK_741fa976d1e04e695f3aa23cb89" FOREIGN KEY ("apiKeyId") REFERENCES "api_keys"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "api_keys" ADD CONSTRAINT "FK_1888b4544f52d274e98f6f1aa62" FOREIGN KEY ("organizationId") REFERENCES "organizations"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "usage_records" ADD CONSTRAINT "FK_139b12af7ac259044807889d062" FOREIGN KEY ("organizationId") REFERENCES "organizations"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "organizations" ADD CONSTRAINT "FK_98b5c76732833827055b1f147d3" FOREIGN KEY ("planId") REFERENCES "plans"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "webhook_endpoints" ADD CONSTRAINT "FK_2bf25c8e57515f3d8662d6159ce" FOREIGN KEY ("organizationId") REFERENCES "organizations"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "webhook_deliveries" ADD CONSTRAINT "FK_e4dca936b75c3f9d0d38ff18457" FOREIGN KEY ("webhookEndpointId") REFERENCES "webhook_endpoints"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "webhook_deliveries" DROP CONSTRAINT "FK_e4dca936b75c3f9d0d38ff18457"`);
        await queryRunner.query(`ALTER TABLE "webhook_endpoints" DROP CONSTRAINT "FK_2bf25c8e57515f3d8662d6159ce"`);
        await queryRunner.query(`ALTER TABLE "organizations" DROP CONSTRAINT "FK_98b5c76732833827055b1f147d3"`);
        await queryRunner.query(`ALTER TABLE "usage_records" DROP CONSTRAINT "FK_139b12af7ac259044807889d062"`);
        await queryRunner.query(`ALTER TABLE "api_keys" DROP CONSTRAINT "FK_1888b4544f52d274e98f6f1aa62"`);
        await queryRunner.query(`ALTER TABLE "audit_logs" DROP CONSTRAINT "FK_741fa976d1e04e695f3aa23cb89"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_e4dca936b75c3f9d0d38ff1845"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_139b12af7ac259044807889d06"`);
